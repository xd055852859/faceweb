        ...
        if (canvasDom) {
            ...
            if (drawBgContext) {
                ...
                if (background) {
                    ...
                    contextBackground.arc(backgroundArr[57].x + top, backgroundArr[57].y + left, 0.9, 0, 2 * Math.PI);
                    this.drawRectLine(backgroundArr[57].x + top, backgroundArr[57].y + left, backgroundArr[17].x + top, backgroundArr[17].y + left, contextBackground);
                    this.drawRectLine(backgroundArr[57].x + top, backgroundArr[57].y + left, backgroundArr[30].x + top, backgroundArr[30].y + left, contextBackground);
                    this.drawRectLine(backgroundArr[57].x + top, backgroundArr[57].y + left, backgroundArr[50].x + top, backgroundArr[50].y + left, contextBackground);
                    this.drawRectLine(backgroundArr[57].x + top, backgroundArr[57].y + left, backgroundArr[53].x + top, backgroundArr[53].y + left, contextBackground);
                    this.drawRectLine(backgroundArr[19].x + top, backgroundArr[19].y + left, backgroundArr[58].x + top, backgroundArr[58].y + left, contextBackground);
                    this.drawRectLine(backgroundArr[36].x + top, backgroundArr[36].y + left, backgroundArr[62].x + top, backgroundArr[62].y + left, contextBackground);
                    ...
                    backgroundNumArr.forEach((item, index) => {
                        //圆点
                        contextBackground.beginPath();
                        contextBackground.arc(backgroundArr[item].x + top, backgroundArr[item].y + left, 0.9, 0, 2 * Math.PI);
                        if (index < backgroundNumArr.length - 1) {
                            this.drawRectLine(backgroundArr[item].x + top, backgroundArr[item].y + left, backgroundArr[backgroundNumArr[index + 1]].x + top, backgroundArr[backgroundNumArr[index + 1]].y + left, contextBackground);
                        }
                        contextBackground.strokeStyle = "rgba(255,255,255,0.2)";
                        contextBackground.stroke();
                        contextBackground.closePath();
