...
class TongueReport extends Component {
     ...
     */
    toIndex() {
        this.props.setTongueUpImgSrc('')
        this.props.setTongueDownImgSrc('')
                    ...
                    <div className="report-message-container" id="reportHtml" >
                        ...
                        <div className="report-message-info">
                            ...
                            <div className="report-message-info-div" style={{ marginBottom: "0.2rem" }}>
                                ...
                                {treatPlanJson.main_performance.map((item, index) => {
                                    return <div key={'main' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                                ...
                                {treatPlanJson.occur_reason.map((item, index) => {
                                    return <div key={'occur' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                                <div className="report-message-bottom-image">
                                    <div className="leftSrc"></div>
                                    <img className="report-message-line" src="./images/report-message-line.png" alt="" />
                                ...
                                {treatPlanJson.predisposition.map((item, index) => {
                                    return <div key={'predisposition' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                            </div>
                            <div className="report-message-info-div" style={{ marginTop: "-0.2rem", marginBottom: "0.2rem" }}>
                                ...
                                {treatPlanJson.diet_rehabilitation.map((item, index) => {
                                    return <div key={'diet' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                                <div className="report-message-bottom-image">
                                    <div className="leftSrc"></div>
                                    <img className="report-message-line" src="./images/report-message-line.png" alt="" />
                                ...
                                <div className="report-message-info-text-subtitle">中医调理</div>
                                {treatPlanJson.drug_health_care.map((item, index) => {
                                    return <div key={'drug' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                                <div className="report-message-bottom-image">
                                    <div className="leftSrc"></div>
                                    <img className="report-message-line" src="./images/report-message-line.png" alt="" />
                                ...
                                <div className="report-message-info-text-subtitle">按摩调理</div>
                                {treatPlanJson.massage_health_care.map((item, index) => {
                                    return <div key={'massage' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                                <div className="report-message-bottom-image">
                                    <div className="leftSrc"></div>
                                    <img className="report-message-line" src="./images/report-message-line.png" alt="" />
                                ...
                                <div className="report-message-info-text-subtitle">恢复调理</div>
                                {treatPlanJson.recuperates.map((item, index) => {
                                    return <div key={'recuperates' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                                <div className="report-message-bottom-image">
                                    <div className="leftSrc"></div>
                                    <img className="report-message-line" src="./images/report-message-line.png" alt="" />
                                ...
                                {treatPlanJson.sports_health_care.map((item, index) => {
                                    return <div key={'health' + index} className="report-message-info-text-info">{item.message}</div>
                                })}
                            </div>
