            ...
            <div className="container fullContainer">
                ...
                <div className="home-button">
                    <div className="home-info-text button-left-image home-info-button-image home-info-button">
                        <Link className="homeLink" to="/uploadTongueImg"> <img className="home-info-tongueButton" src="./images/tongueButton.svg" alt="" />智能舌诊
                        </Link>
                    </div>
                    ...
                    <div className="home-info-text button-center-image home-info-button-image">
                        <Link className="homeLink" to="/uploadImg"> <img className="home-info-tongueButton" src="./images/faceButton.svg" alt="" />面相探索
                        </Link>
                    </div>
